 ...
 */
public class ChuangLanVarRequest {
    /**
     * 用户账号，必填
     */
    ...
    public ChuangLanVarRequest() {

    }
    public ChuangLanVarRequest(String account, String password, String msg, String params) {
        super();
    ...
    public ChuangLanVarRequest(String account, String password, String msg, String params, String report) {
        super();
        this.account = account;
        this.password = password;
        this.msg = msg;
